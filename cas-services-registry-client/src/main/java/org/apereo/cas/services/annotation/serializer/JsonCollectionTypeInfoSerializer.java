 ...
 */
@JacksonStdImpl
public class JsonCollectionTypeInfoSerializer extends StdScalarSerializer<Collection<?>>
		implements ContextualSerializer {

	private final static long serialVersionUID = 2235740940895178474L;

	public JsonCollectionTypeInfoSerializer() {
		super(Collection.class, false);
	}

	public JsonCollectionTypeInfoSerializer(Class<? extends Collection<?>> v) {
		super(v, false);
	}
	...
	public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property)
		...
		if(format != null){
			return new JsonCollectionTypeInfoSerializer((Class<Collection<?>>) property.getType().getRawClass());
		}
